import{_ as B,W as h,s as w,h as V,v as L,y as z,o as v,c as p,j as o,$ as M,af as E,F as H,E as T,ag as I,t as f,ad as C,p as N,l as O,I as j,a as D}from"./chunks/framework.BWdyHGCx.js";const k=r=>(N("data-v-385e12c0"),r=r(),O(),r),P=k(()=>o("span",null,"|",-1)),A=["d"],R=k(()=>o("circle",{cx:"0",cy:"0",r:"2",fill:"red"},null,-1)),q={class:"left-aside"},F={class:"right-aside"},J=k(()=>o("footer",null,"x:-, y:-",-1)),Q={__name:"Svg",setup(r){const g=h({Mm:{comment:"起点",exp:"M0 0 L100 100",args:`
            - x
            - y
            -
            - dx
